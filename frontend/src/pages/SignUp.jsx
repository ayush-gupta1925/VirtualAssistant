...
function SignUp() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <form
        className="relative z-10 w-[90%] h-[600px] max-w-[500px]   bg-[#a8282869] backdrop-blur-md rounded-lg shadow-lg shadow-[#e44242] flex flex-col items-center justify-center gap-[20px] px-[20px]"
        onSubmit={handleSignUp}
      >
        <h1 className="text-white text-[33px] font-semibold mb-[30px] ">
          {" "}
          Register to
        ...
        <button
          className="w-full h-[60px] outline-none border-2 rounded-full border-white px-[20px] py-[10px] text-black  text-[21px] bg-[#f42b2b] placeholder-gray-300 hover:bg-[#f45959] cursor-pointer mt-[20px]"
          disabled={loading}
        >
        ...
        >
          ...
          <span className="text-yellow-400  hover:underline">Sign In </span>{" "}
        </p>
      </form>
    </div>
  );
